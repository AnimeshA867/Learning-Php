...
if(isset($_POST['updatebtn'])){
    ...
    $updateSql = "UPDATE Student_tbl SET studentname='".$name."', studentemail='".$email."', studentcity='".$city."', studentgender='".$gender."', studentcourse='".$course."', studentcountry='".$country."' WHERE studentid=".$id;
